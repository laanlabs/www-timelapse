...
$vg.='<div style="width:100%; height: 18px; padding:3px; background-color:#ddd; border-bottom:1px solid #000; margin-bottom: 8px">
<div style="float:left">Order By:</div>	
<div style="float:left;padding-left: 10px"><a href="?ob=viewCount">view count</a></div>	
<div style="float:left;padding-left: 10px"><a href="?ob=published">published</a></div>	
</div>
<br clear="both"/>';
