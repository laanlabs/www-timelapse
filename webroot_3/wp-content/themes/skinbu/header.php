...
<div id="container">
	...
	<div id="header" >
		...
		<div id="raccoglitore" style="height:200px;" >
			<div style="position:relative;top:70px;">
				<a href="http://bit.ly/iTimeLapse" target="_new" title="<?php bloginfo('name'); ?>- <?php bloginfo('description'); ?>"><img width="959" height="130" src="/images/timelapse-header.jpg" alt="<?php bloginfo('name'); ?>- <?php bloginfo('description'); ?>" /></a>
			</div>
